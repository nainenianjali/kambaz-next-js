...
<div id="wd-css-position-fixed">
  ...
  Checkout the blue square that says Fixed positions stuck all the way on the right and half way down the page. It doesnt scroll with the rest of the page. Its position is Fixed.
